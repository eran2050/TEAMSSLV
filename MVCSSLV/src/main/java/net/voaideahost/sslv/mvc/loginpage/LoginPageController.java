package net.voaideahost.sslv.mvc.loginpage;

import static net.voaideahost.sslv.common.Config.ACTION_DELETE;
import static net.voaideahost.sslv.common.Config.ACTION_LOGIN;
import static net.voaideahost.sslv.common.Config.ACTION_LOGOUT;
import static net.voaideahost.sslv.common.Config.ACTION_NOT_AUTHORIZED;
import static net.voaideahost.sslv.common.Config.STATUS_AD_DELETED;
import static net.voaideahost.sslv.common.Config.STATUS_LOGGED_IN;
import static net.voaideahost.sslv.common.Config.STATUS_LOGGED_OUT;
import static net.voaideahost.sslv.common.Config.STATUS_NOT_LOGGED_IN;
import static net.voaideahost.sslv.common.Config.STATUS_NO_SUCH_USER;
...
import static net.voaideahost.sslv.common.Config.VAL_CONTEXT_ROOT;
import static net.voaideahost.sslv.common.Config.VAL_EMPTY;
import static net.voaideahost.sslv.common.Config.VAL_PAGES_IN_LINE;
import static net.voaideahost.sslv.common.Config.VAL_USERNAME;
...
import net.voaideahost.sslv.common.Util;

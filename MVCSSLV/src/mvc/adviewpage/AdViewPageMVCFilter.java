...
public class AdViewPageMVCFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        IModelCreator modelCreator = (IModelCreator) ctx.getBean(uriMapping.getModelCreator());
    ...
    public void init(FilterConfig fConfig) throws ServletException {
        ...
        URIMapping adViewPageMapping = new URIMappingBuilder().build(
                "/adview/", AdViewPageModelCreator.class,
                AdViewPageController.class, "/jsp/adviewpage.jsp");
